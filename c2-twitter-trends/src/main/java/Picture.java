...
// * <p>
// * The {@code get()} and {@code set()} methods use {@link Color} objects to
// get
// * or set the color of the specified pixel. The {@code getRGB()} and
// * {@code setRGB()} methods use a 32-bit {@code int} to encode the color,
// * thereby avoiding the need to create temporary {@code Color} objects. The
// red
...
// *
// * @param pixels
// * the new colors of the pixels for the picture
// * @throws IllegalArgumentException
// * if the dimensions of {@code pixels} do not match the dimensions
// * of the picture
// */
