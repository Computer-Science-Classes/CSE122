...
//
// /**
// * The {@code Tweet} class represents a tweet with an associated photo,
// caption,
// * date, and likes. The class provides methods to retrieve and manipulate the
// * tweet information, including resizing the photo and generating a formatted
// * string representation of the tweet.
// */
// public class Tweet {
//
// /**
// * The desired size for the resized photo. You may change this value as you
// see
// * fit to resize the photo!
// */
// public static final int PHOTO_SIZE = 30;
//
...
//
// /**
// * Constructs a new {@code Tweet} with specified photo, caption, date, likes,
// * and retweets.
// *
// * @param photoString
...
// * @param retweets
// * The number of retweets on the tweet
// *
// * @throws IllegalArgumentException
// * If retweets are less than 0 or photo dimensions are smaller than
// * {@code PHOTO_SIZE}
// */
// public Tweet(String photoString, String caption, String date, int likes, int
// retweets) {
// if (retweets < 0) {
// throw new IllegalArgumentException("Retweets are less than zero: " +
// retweets);
// }
...
// "Photo must be at least " + PHOTO_SIZE + " pixels in each dimension");
// }
...
//
// /**
// * Constructs a new {@code Tweet} with a specified photo, caption, and date
// * where it automatically assigns random values for likes and retweets.
// *
// * @param photoString
// * The file path of the photo
// * @param caption
...
// *
// * @throws IllegalArgumentException
// * If photo dimensions are smaller than {@code PHOTO_SIZE}
// */
// public Tweet(String photoString, String caption, String date) {
// this(photoString, caption, date, new Random().nextInt(100000), new
...
//
// /**
// * Returns the 2D array of {@link Color} objects representing the photo
// pixels.
// *
...
// *
// * @param pixels
// * The new 2D array of {@link Color} objects for the photo
// */
...
// *
// * @param caption
// * The new caption to set for the tweet.
// */
...
//
// /**
// * Returns a string representation of this tweet, including its photo
// * (represented as colored spaces), caption, number of likes, retweets, and
// the
// * date.
// *
...
//
// /**
// * Compares this tweet with another object to determine if they are equal. Two
// * tweets are considered equal if they have the same photo, caption, date,
// * number of likes, and number of retweets.
// *
// * @param other
// * The object to compare against
// *
// * @return True if the other object is a Tweet with identical photo, caption,
// * date, likes, and retweets
// */
...
// return (this.photo.equals(otherTweet.photo) &&
// this.caption.equals(otherTweet.caption)
// && this.date.equals(otherTweet.date) && this.likes == otherTweet.likes
...
//
// /**
// * Resizes the provided photo for this tweet to be of PHOTO_SIZE in each
// * dimension. The central sqaure will be selected.
// *
// * @param The
// * 2D color representation of the original photo
// *
...
//
// /**
// * Selects the central square of an image. The image must be at least as tall
// as
// * it is wide.
// *
// * @param The
...
//
// /**
// * Converts the photo of this tweet to a String. The returned String will be
// * made of spaces where each pair of spaces represents a pixel and is assigned
// a
// * ansi color background value.
// *
// * @param The
// * 2D color representation of the original photo
// *
...
// int ansiCode2 = 16 + (36 * (color.getRed() / 51)) + (6 * (color.getGreen() /
// 51))
// + (color.getBlue() / 51);;
//
// // int ansiColorCode = rgbToAnsi(color.getRed(), color.getGreen(),
// // color.getBlue());
