...
/**
 * The {@code Tweet} class represents a tweet with an associated photo, caption,
...
public class Tweet {
    ...
    /**
     * The desired size for the resized photo. You may change this value as you see
    ...
    public Tweet(String photoString, String caption, String date) {
        this(photoString, caption, date, new Random().nextInt(100000), new Random().nextInt(50000));
    }
     ...
     * (represented as colored spaces), caption, number of likes, retweets, and the
     * date.
     *
    ...
    public boolean equals(Object other) {
        if (other == this) {
            ...
            return (this.photo.equals(otherTweet.photo) && this.caption.equals(otherTweet.caption)
    ...
    /**
     * Selects the central square of an image. The image must be at least as tall as
     * it is wide.
     *
     * @param The
     *            2D color representation of the original photo
     ...
     * made of spaces where each pair of spaces represents a pixel and is assigned a
